    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="bg-linear-to-r from-teal-600 to-cyan-600 rounded-lg p-6 text-white mb-8">
          ...
          {isLoadingClinic ? (
            <p className="text-teal-100">Loading clinic information...</p>
          ) : (
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <p className="font-medium text-gray-900">{t.managementStaff}</p>
                  <p className="text-sm text-gray-600">{t.manageEmployees}</p>
                </div>
              </button>

              <button
                onClick={() => router.push('/clinic/manage-schedule')}
                className="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:border-teal-500 hover:bg-teal-50 transition-all"
              >
