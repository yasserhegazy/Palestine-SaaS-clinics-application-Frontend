...
export default function ForbiddenPage() {
  ...
  const translations = {
    en: {
      ...
      explanation: 'This page is restricted to specific user roles. Your current role does not have the necessary permissions to view this content.',
    ...
    ar: {
      ...
      explanation: 'هذه الصفحة مقيدة لأدوار مستخدمين محددة. دورك الحالي لا يملك الصلاحيات اللازمة لعرض هذا المحتوى.',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 flex items-center justify-center px-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-red-500 via-red-600 to-rose-600 px-8 py-12 text-center">
          ...
          <div className="px-8 py-8 space-y-6">
            ...
            {user && role && (
              <div className="bg-slate-50 rounded-xl p-5 border border-slate-200">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-slate-200">
                  <span className="text-sm text-slate-600">{t.currentRole}:</span>
            ...
            {attemptedPath && (
              <div className="bg-red-50 rounded-xl p-5 border border-red-200">
                ...
                <code className="block bg-white px-3 py-2 rounded-lg text-sm text-red-900 font-mono border border-red-200">
                  {attemptedPath}
                </code>
              </div>
            )}
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <button
                ...
                className="flex-1 px-6 py-3 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-xl font-semibold hover:from-teal-700 hover:to-cyan-700 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
              >
                {t.goToDashboard}
              </button>
              <button
                onClick={handleGoBack}
                className="flex-1 px-6 py-3 bg-slate-100 text-slate-700 rounded-xl font-semibold hover:bg-slate-200 transition-all border border-slate-300"
              >
                {t.goBack}
              </button>
            </div>
